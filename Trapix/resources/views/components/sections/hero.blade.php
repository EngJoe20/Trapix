<section class="relative pt-32 lg:pt-36">
    ...
    <x-shared.container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        <div
            ...
            <h1
                class="text-3xl leading-tight sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight xl:text-6xl xl:leading-tight font-bold text-heading-1">
            ...
            <x-shared.paragraph className="mt-8">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolores repellat perspiciatis aspernatur quis
                voluptatum porro incidunt,
                ...
                <div class="flex sm:flex-row flex-col gap-5 w-full">
                    ...
                    <form action="#"
                        class="py-1 pl-6 w-full pr-1 flex gap-3 items-center text-heading-3 shadow-lg shadow-box-shadow
                          border border-box-border bg-box-bg rounded-full ease-linear focus-within:bg-bg focus-within:border-primary">
                        ...
                        <x-shared.button variant="primary" className="min-w-max text-white">
        ...
        <div class="flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-none lg:mx-0 mx-auto max-w-3xl">
            ...
            <img src="{{ asset('images/image1.webp') }}" alt="Hero image" width="2350" height="2359"
