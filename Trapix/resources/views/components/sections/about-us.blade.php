<section id="about-us">
    ...
    <x-shared.container className="flex flex-col midmd:flex-row gap-10 lg:gap-12">
        ...
        <div class="max-w-md mx-auto midmd:max-w-none lg:mx-0 lg:pr-10 xl:pr-2 flex-1 flex w-11/12 midmd:w-5/12 lg:w-1/2 midmd:h-auto">
            ...
            <div class="w-full h-80 sm:h-96 midmd:h-full relative">
                ...
                <img
                    src="{{ asset('images/dev-with-c-1.webp') }}"
                    alt="banner image"
                    width="1240"
                    height="1385"
        ...
        <div class="flex-1 flex midmd:w-7/12 lg:w-1/2 flex-col">
            ...
            <x-shared.paragraph className="mt-8">
                ...
                Minus, saepe aliquid autem alias vero distinctio dignissimos
                consequatur? Excepturi quibusdam, quam ipsum hic, laudantium
